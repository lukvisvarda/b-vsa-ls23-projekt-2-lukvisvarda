 ...
 */
@ApiModel(description = "Objekt študenta s identifikátormi záverečnej práce namiesto kolekcie objektov.")
...
public class TeacherAltResponse {
  ...
  private List<Long> theses = null;


  public TeacherAltResponse id(Long id) {
  ...
  **/
  ...
  public TeacherAltResponse aisId(Long aisId) {
  ...
  **/
  ...
  public TeacherAltResponse name(String name) {
  ...
  **/
  ...
  public TeacherAltResponse email(String email) {
  ...
  **/
  ...
  public TeacherAltResponse password(String password) {
  ...
  **/
  ...
  public TeacherAltResponse institute(String institute) {
  ...
  **/
  ...
  public TeacherAltResponse department(String department) {
  ...
  **/
  ...
  public TeacherAltResponse theses(List<Long> theses) {
    
    this.theses = theses;
    return this;
  }

  public TeacherAltResponse addThesesItem(Long thesesItem) {
    if (this.theses == null) {
      this.theses = new ArrayList<Long>();
    }
   ...
   /**
   * ID záverečných prác vytvorené učiteľom. Ak učiteľ nevytvoril žiadne záverečné práce je tento atribút vynechaný.
   * @return theses
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID záverečných prác vytvorené učiteľom. Ak učiteľ nevytvoril žiadne záverečné práce je tento atribút vynechaný.")

  public List<Long> getTheses() {
    return theses;
  }


  public void setTheses(List<Long> theses) {
    this.theses = theses;
  }
  ...
  public boolean equals(Object o) {
    ...
    TeacherAltResponse teacherAltResponse = (TeacherAltResponse) o;
    return Objects.equals(this.id, teacherAltResponse.id) &&
        Objects.equals(this.aisId, teacherAltResponse.aisId) &&
        Objects.equals(this.name, teacherAltResponse.name) &&
        Objects.equals(this.email, teacherAltResponse.email) &&
        Objects.equals(this.password, teacherAltResponse.password) &&
        Objects.equals(this.institute, teacherAltResponse.institute) &&
        Objects.equals(this.department, teacherAltResponse.department) &&
        Objects.equals(this.theses, teacherAltResponse.theses);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, aisId, name, email, password, institute, department, theses);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeacherAltResponse {\n");
